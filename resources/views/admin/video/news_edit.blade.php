                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            ...
                            <form class="user" method="POST"  action="{{route('video.update',$edit_data->id)}}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                   ...
                                   <textarea cols="100%" id="editor1" name="post" rows="5" class="form-control">
                                        {{$edit_data->post}}
                                         ...
                                         <small class="text-info"> <i class="text-dark feather icon-help-circle"></i>({{__('Please enter video')}})</small>
                                     </div>    
                                </div>
