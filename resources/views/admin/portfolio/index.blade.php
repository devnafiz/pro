    ...
    <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="{{route('portfolio.create')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-plus fa-sm text-white-50"></i> Create Portfolio </a>
                    </div>
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$val->heading}}</td>
                                            <td>{{$val->des}}</td>
                                            <td>{{$val->port_category->name}}</td>
                                            <td>{{($val->status==1)? 'active' :'Deactive'}}</td>
                                            <td><a href="{{route('portfolio.edit',$val->id)}}"><i class="fas fa-edit"></i></a>
                                               <a href="{{route('portfolio.delete',$val->id)}}" id="delete"><i class="fas fa-trash"></i></a>
                                            </td>
