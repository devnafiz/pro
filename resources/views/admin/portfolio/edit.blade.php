    ...
    <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="{{route('portfolio.index')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-list fa-sm text-white-50"></i>  Portfolio List</a>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Edit  Portfolio </h1>
                            </div>
                            <form class="user" method="POST"  action="{{route('portfolio.update',$edit_data->id)}}" enctype="multipart/form-data">
                              @method('PUT')
                                @csrf
                                ...
                                <div class="form-group ">
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                        <input type="text" class="form-control " placeholder="{{ __('Please enter name') }}" type="text" id="heading" name="heading" value="{{$edit_data->heading}}">
                                    </div>
                                 ...
                                 <div class="form-group ">
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                        <select class="form-control" name="cat_id">
                                          ...
                                          @foreach($port_cat as $val)
                                          <option value="{{$val->id}}" {{ ($edit_data->cat_id==$val->id) ? 'selected' :''}}>{{$val->name}}</option>
                                         @endforeach
                                        </select>
                                    </div>
