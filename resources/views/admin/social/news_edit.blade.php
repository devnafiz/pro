...
@section('admin')
    ...
    <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="{{route('social.activity.all')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-list fa-sm text-white-50"></i>Social  Activity List</a>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Edit  Activity </h1>
                            </div>
                            <form class="user" method="POST"  action="{{route('social.activity.update',$edit_data->id)}}" enctype="multipart/form-data">
                                @csrf
