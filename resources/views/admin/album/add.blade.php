                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Create Photo </h1>
                            </div>
                            <form class="user" method="POST"  action="{{route('album.store')}}" enctype="multipart/form-data">
                                @csrf
