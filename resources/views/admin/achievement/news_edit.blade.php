...
@section('admin')
    ...
    <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="{{route('achievement.all')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-list fa-sm text-white-50"></i>Achievement List</a>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Edit  Achievement </h1>
                            </div>
                            <form class="user" method="POST"  action="{{route('achievement.update',$edit_data->id)}}" enctype="multipart/form-data">
                                @csrf
