...
@section('admin')
    ...
    <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="{{route('Client.index')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-list fa-sm text-white-50"></i>  Client List</a>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            ...
                            <form class="user" method="POST"  action="{{route('Client.update',$edit_data->id)}}" enctype="multipart/form-data">
                              @method('PUT')
                                @csrf
